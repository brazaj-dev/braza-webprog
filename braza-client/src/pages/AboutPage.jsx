        ...
        <div className="grid gap-8 lg:grid-cols-2 lg:items-center">
          <div className="rounded-3xl border-2 border-dashed border-zinc-300 bg-zinc-100 p-6">
            <div className="flex min-h-72 items-center justify-center rounded-[1.25rem] bg-zinc-200">
              <img
                src={profileImg}
                alt="Profile"
                className="h-full w-full rounded-[1.25rem] border-3 border-zinc-400 object-cover flex-shrink-0"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <p className="mt-4 max-w-lg text-sm leading-7 text-zinc-600 sm:text-base">
              Currently a student at National University, pursuing a Bachelor of
              Science in Information Technology, with a strong interest in
              developing innovative solutions and enhancing technical skills in
              programming, web development, and system design.
            </p>
            <div className="mt-6 flex flex-wrap gap-8 justify-content">
